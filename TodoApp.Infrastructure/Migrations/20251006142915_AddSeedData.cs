    ...
    public partial class AddSeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), 0, "static-concurrency-stamp-1", new Guid("11111111-1111-1111-1111-111111111111"), "test1@example.com", true, false, null, "TEST1@EXAMPLE.COM", "TEST USER 1", "AQAAAAIAAYagAAAAEBx8l2zY9dY8K+nJvQWg3ZnYq+4L5m9jX2pZ8nV7wQ3f0t1R5s6u9pA2bC3d4E5f6G7h8I9j", null, false, "static-security-stamp-1", false, "Test User 1" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 0, "static-concurrency-stamp-2", new Guid("22222222-2222-2222-2222-222222222222"), "test2@example.com", true, false, null, "TEST2@EXAMPLE.COM", "TEST USER 2", "AQAAAAIAAYagAAAAECy9m3aZ0eZ9L+oKwRXh4aoZr+5M6n0kY3qA9oW8xR4g1u2S6t7v0qB3cD4e5F6g7H8i9J0k", null, false, "static-security-stamp-2", false, "Test User 2" }
                });
